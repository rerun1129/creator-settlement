...
class CourseIdTest {
    ...
    void should_create_course_id_when_value_is_present() {
        ...
        // when
        CourseId courseId = CourseId.of(value);
    ...
    void should_throw_when_value_is_null() {
        // given & when & then
        assertThatThrownBy(() -> CourseId.of(null))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage(DomainErrorMessage.COURSE_ID_NULL.message());
    }
    ...
    void should_be_equal_when_values_are_same() {
        // given
        CourseId courseId1 = CourseId.of(42L);
        CourseId courseId2 = CourseId.of(42L);
    ...
    void should_not_be_equal_when_values_differ() {
        // given
        CourseId courseId1 = CourseId.of(1L);
        CourseId courseId2 = CourseId.of(2L);
